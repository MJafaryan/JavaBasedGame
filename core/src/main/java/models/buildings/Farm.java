...
public class Farm extends Building implements Upgradable {
    private int lvl;
    ...
    public Farm(Colony colony) {
        super(colony);
        this.health = (int) (long) SimplerJson.getDataFromJson(cost, "farms_farm_health");
        this.lvl = 1;
    }
    ...
    public void upgrade() throws Exception {
        ...
        if (lvl < 3) {
            newlvl = (JSONObject) SimplerJson.getDataFromJson(this.cost, "farms_farm_lvl" + (this.lvl + 1));
        }
