...
public class GoldMine extends Building implements Upgradable {
    ...
    public GoldMine(Colony colony) {
        super(colony);
        this.health = (int) (long) SimplerJson.getDataFromJson(cost, "farms_goldMine_health");
        this.lvl = 1;
    }
    ...
    public void upgrade() throws Exception {
        ...
        if (lvl < 3) {
            newlvl = (JSONObject) SimplerJson.getDataFromJson(this.cost, "farms_goldMine_lvl" + (this.lvl + 1));
        }
