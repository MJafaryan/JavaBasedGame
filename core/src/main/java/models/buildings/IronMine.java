...
public class IronMine extends Building implements Upgradable {
    ...
    public IronMine(Colony colony) {
        super(colony);
        this.health = (int) (long) SimplerJson.getDataFromJson(cost, "farms_ironMine_health");
        this.lvl = 1;
    }
    ...
    public void upgrade() throws Exception {
        ...
        if (lvl < 3) {
            newlvl = (JSONObject) SimplerJson.getDataFromJson(this.cost, "farms_ironMine_lvl" + (this.lvl + 1));
        }
