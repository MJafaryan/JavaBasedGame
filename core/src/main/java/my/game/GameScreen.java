...
public class GameScreen implements Screen {
    ...
    public void createRightBottomToolbar() {
        if (rightBottomToolbarCreated || !townHallPlaced)
            return;
    ...
    public void updateResourcesDisplay() {
        ...
        String resourcesText = String.format(
                "Wood: %d | Stone: %d | Coin: %d | Iron: %d | Food: %d | Free Citizens: %d/%d | Storage: %d/%d",
                ...
                playerColony.getUnemployedCitizens(), playerColony.getPopulation(),
                        ...
                        if (cost != null) {
                            ...
                            for (String material : Basics.MATERIALS_NAME) {
                                ...
                                if (materialCostObj != null) {
                                    int costAmount = parseMaterialCost(materialCostObj);
                                    if (costAmount > 0) {
                                        playerColony.updateRecourse(configKey, -costAmount);
                            ...
                            addMessage(
                                    selectedBuilding.getType() + " upgraded to level " + selectedBuilding.getLevel());
    ...
    public Map<String, Texture> getBuildingTextures() {
        return buildingTextures;
    }

    public Colony getPlayerColony() {
        return playerColony;
    }
    ...
    public void setTownHallPlaced(boolean townHallPlaced) {
        this.townHallPlaced = townHallPlaced;
    }
    ...
    public void setHasTownHall(boolean hasTownHall) {
